...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="flex">
        <div className="flex flex-col justify-center px-4 py-8 sm:px-4 lg:flex-row lg:justify-between lg:px-6 lg:py-12">
          <svg
          ...
          >
            ...
            <path
              ...
              fill="#ccc"
            />
            <circle cx="524.99994" cy="335.5" r="16" fill="#ff6376" />
            <polygon
